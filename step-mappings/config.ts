...
export const config: IStepMappingConfig = {
  excludedFolders: [ // list of folders that should be excluded while searching all step files
    "config", "build", "step-mappings", "reports", "step-snippets", "step-templates", "tools"],
